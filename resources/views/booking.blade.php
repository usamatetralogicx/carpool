...
<h4 class="card-title m-t-40" id="6">6. Your car details</h4>
<!-- car section starts here -->
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>   
                    ...
                    <button type="button" class="btn waves-effect waves-light  btn-danger button-confirm" data-id="{{$info->id}}" rel="tooltip" title="Not Confirm"><i class="fa fa-ban" ></i></button>
                     @else
